...
const IntroPage = () => {
  return (
    <main className="md:flex md:justify-center gap-16 p-6 font-poppins items-center max-w-xl md:max-w-[1600px]">
      ...
      <div className="flex flex-col gap-6 md:w-1/3 md:min-w-[426px]">
