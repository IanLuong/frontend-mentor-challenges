  ...
  return (
    <form className="bg-white rounded-xl shadow-xl p-6 flex flex-col gap-5 font-semibold" onSubmit={handleSubmit}>
      <div className="flex flex-col gap-3">
        ...
        {!formDetails.firstName && <p className="text-right italic text-customRed text-[.7rem]">First Name cannot be empty</p>}
        ...
        {!formDetails.lastName && <p className="text-right italic text-customRed text-[.7rem]">Last Name cannot be empty</p>}
        ...
        {!formDetails.email.match(/\w+@\w+(.\w+)+/) && <p className="text-right italic text-customRed text-[.7rem]">Looks like this is not an email</p>}
        ...
        {!formDetails.password && <p className="text-right italic text-customRed text-[.7rem]">Password cannot be empty</p>}
      </div>
